...
main = tkinter.Tk()
main.title("ENSURING RESILIENT AND CONFIDENTIAL DATA TRANSMISSION WITH ARTIFICIAL INTELLIGENCE IN AD-HOC NETWORKS")
...
def calculateMetrics(predict, y_test, algorithm):
    ...
    CR = classification_report(y_test, predict,target_names=class_labels)
...
font = ('times', 15, 'bold')
title = Label(main, text='ENSURING RESILIENT AND CONFIDENTIAL DATA TRANSMISSION WITH ARTIFICIAL INTELLIGENCE IN AD-HOC NETWORKS')
